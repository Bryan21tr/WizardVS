...
namespace WizardVS.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Producto,Nombre,Marca,Cantidad,Precio")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Producto,Nombre,Marca,Cantidad,Precio")] Producto producto)
        {
